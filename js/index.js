...
$(async function() {
    ...
    window.location.href.split('/')[window.location.href.split('/').length - 1] == 'profile' ? 
        categories.slice(0,3).map((x, index) => counterPopulator({...x, counter: counters[index]}, index)) :
